...
public class A_Lambdas {
    ...
    public void c_consumer1() {
        Consumer<StringBuilder> cons = stringBuilder -> stringBuilder.append("abc");
    ...
    public void e_bifunction1() {
        BiFunction<String, String, String> bifunc = (str1, str2) -> str1+str2+str1;
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (str1, str2) -> str1.indexOf(str2);
