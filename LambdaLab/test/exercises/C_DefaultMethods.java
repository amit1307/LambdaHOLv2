...
public class C_DefaultMethods {
    ...
    public void c02_removeOddLengthWords() {
        ...
        list.removeIf(string -> string.length() != 4);
    ...
    public void c04_appendToMapValues() {
        ...
        map.forEach((key, value) -> value.append(key.toString()));
    ...
    public void c05_replaceMapValues() {
        ...
        map.replaceAll((key, value) -> value + (key.toString()));
    ...
    public void c06_mapOfListOfStringsByLength() {
        ...
        list.forEach(string -> result.computeIfAbsent(string.length(), key -> new ArrayList<>()).add(string));
    ...
    public void c07_mapOfStringByInitialCharacter() {
        ...
        list.forEach(string -> result.merge(string.charAt(0), string, (val1, val2) -> val1 + ":" +val2));
    ...
    public void c11_computeWithMissingEntries() {
        ...
        keys.forEach(key -> map.compute(key, (mapKey, value) -> map.get(mapKey) != null ? map.get(mapKey).toUpperCase() : key));
